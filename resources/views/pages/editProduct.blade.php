    ...
    <div class="add-product-container">
        <div class="form-imageContainer">
            ...
            <div class="imageUploadContainer">
                ...
                <img id="placeholderImage" src="{{ asset('storage/' . $product->image_path) }}" alt="Placeholder Image" style="display: block;"/>
            </div>
            <div class="add-product-form">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="productImage">Image (No need if don't want update image):</label>
                    ...
                    <input type="text" id="productPrice" name="productPrice" value="{{ $product->price }}" required>
                    @error('productPrice')
                        <div class="error">{{ $message }}</div>
                    @enderror
